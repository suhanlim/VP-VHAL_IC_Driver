...
extern void Rte_Call_R_CS_STD_SWC_MNGR_SPI_Transmit(uint8 seqid, const uint8* data, uint16 datalen, TE_STD_SPI_RESULT* result);

void Rte_Call_R_CS_STD_SWC_MNGR_SPI_Transmit(uint8 seqid, const uint8* data, uint16 datalen, TE_STD_SPI_RESULT* result)
{
